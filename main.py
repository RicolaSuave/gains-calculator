...
input_workdays = int(input("Input # of days you would like to workout: "))   
input_workout_type = input("Enter starting workout, 'push', 'pull', or 'legs': ")
...
max_value = 3
for i in range((input_workdays)):
    input_code = (input_code + 1) % max_value
